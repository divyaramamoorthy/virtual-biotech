...
class TestAuditTrackerCapture:
    ...
    def test_user_message_after_notification_updates_report(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            tracker.handle_message(_make_task_notification(task_id, "Test analysis", tool_use_id=tool_use_id))
            ...
            tracker.handle_message(_make_user_message_with_result(tool_use_id, "This is the analysis result."))
    ...
    def test_parallel_agents_both_captured(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            tracker.handle_message(_make_task_notification(task_id_1, "Genetics", tool_use_id=tu_id_1))
            tracker.handle_message(_make_task_notification(task_id_2, "Pharmacology", tool_use_id=tu_id_2))
    ...
    def test_output_file_takes_precedence(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            tracker.handle_message(_make_task_notification(task_id, "File test", output_file=output_path, tool_use_id=tool_use_id))
    ...
    def test_no_result_gives_no_output(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            tracker.handle_message(_make_task_notification(task_id, "Empty", tool_use_id=tool_use_id))
    ...
    def test_user_message_selects_longest_text(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            tracker.handle_message(_make_task_notification(task_id, "Multi", tool_use_id=tool_use_id))
